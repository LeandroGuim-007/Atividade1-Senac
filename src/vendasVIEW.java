...
public class vendasVIEW extends javax.swing.JFrame {
    ...
    public DefaultTableModel montarTabela() {
        ...
        ArrayList<ProdutosDTO> produtosVendidos = pdao.listarProdutosVendidos();

        for (ProdutosDTO pDTO : produtosVendidos) {
            String[] linhas = {
                String.valueOf(pDTO.getId()),
                pDTO.getNome(),
                String.valueOf(pDTO.getValor()),
                pDTO.getStatus()
            };
